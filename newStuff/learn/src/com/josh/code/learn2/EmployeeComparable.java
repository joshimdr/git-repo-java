...
public class EmployeeComparable implements Comparable<EmployeeComparable> {
	...
	/*
	 * public Employee(int empId,String empName,String empAddress){ this.empId =
	 * empId; this.empName=empName; this.empAddress=empAddress; }
	 */
	...
	private void printEmployee(ArrayList<EmployeeComparable> emps) {
		...
		if (null != emps) {
			for (Iterator iterator = emps.iterator(); iterator.hasNext();) {
				...
				System.out.println(
						employee.empId + "           " + employee.empName + "          " + employee.empAddress);
